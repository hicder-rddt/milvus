...
SAME_FIELD_OR_FANOUT_EXPRESSIONS_L1 = [case for case in SAME_FIELD_OR_FANOUT_CASES if case[2] in {2, 3, 5}]
...
SCALAR_FILTER_CASES = [
    ...
    for case_name, expr_template, expected_ids in NUMERIC_SCALAR_FILTER_TEMPLATES
]
...
ARRAY_FILTER_CASES = [
    ("arr_i64_contains_3", "array_contains(arr_i64, 3)", [3, 4, 5]),
    ("arr_i64_contains_any", "array_contains_any(arr_i64, [3, 7])", [3, 4, 5, 7, 8, 9]),
...
INDEX_CONSISTENCY_CASES = [
    ...
    },
    {
        ...
        "index_type": "INVERTED",
        "plain_expr": "array_contains(meta_arr_plain['scores'], 3.0)",
        "indexed_expr": "array_contains(meta_arr_indexed['scores'], 3.0)",
        "expected_ids": [3],
    },
    {
        ...
        "field_type": "JSON_ARRAY",
        "index_type": "INVERTED",
        "plain_expr": "array_contains_any(meta_arr_plain['scores'], [2.0, 9.0])",
        "indexed_expr": "array_contains_any(meta_arr_indexed['scores'], [2.0, 9.0])",
        "expected_ids": [2, 9],
    },
    {
        ...
        "field_type": "JSON_ARRAY",
        "index_type": "INVERTED",
        "plain_expr": "meta_arr_plain['scores'] == [2.0, 12.0]",
        "indexed_expr": "meta_arr_indexed['scores'] == [2.0, 12.0]",
        "expected_ids": [2],
    },
]
...
QUERY_POLYGON_PARTIAL = "POLYGON ((0 0, 50 0, 50 50, 0 50, 0 0))"
